...
***************************************************************************** */
import { getTransformedText } from "@nativescript/core";

import { textProperty, MaskedTextFieldBase } from "./common";
...
export class MaskedTextField extends MaskedTextFieldBase {
  ...
  public initNativeView() {
    ...
    const textEdit: android.widget.EditText = this.nativeViewProtected;
    ...
    // Remove the default text watcher that comes from the core modules
